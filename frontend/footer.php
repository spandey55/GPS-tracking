<footer>
        <div class="footer-content">
            ...
            <div class="sugg-wrapper">
              ...
              <br><button class="suggestion_button">Feedback</button>
            </div>

          </div>
        <div class="footer-bottom">
            <p>copyright &copy; <a href="#">Group </a>  </p>
                    <div class="footer-menu">
                      <ul class="f-menu">
                
                        <li>Phone number:<a href="">01-4354882</a></li>
                        <li>email:<a href="">hawa@hawa.com</a></li>
                      </ul>
                    </div>
        </div>
